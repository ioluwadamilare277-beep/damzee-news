...
document.addEventListener("DOMContentLoaded", () => {
            ...
            async event => {
                ...
                try {
                    ...
                    if (emailError) {
                        ...
                        console.error(
                            "DΛMZΞΞ NEWS: Welcome email failed:",
                            emailError
                        );

                        alert(
                            "You're subscribed successfully, but we couldn't send the welcome email right now."
                        );
                    ...
                    if (
                        ...
                        console.error(
                            "DΛMZΞΞ NEWS: Welcome email was not confirmed.",
                            emailData
                        );

                        alert(
                            "You're subscribed successfully, but the welcome email could not be sent."
                        );
                    ...
                    alert(
                        "You're subscribed! Welcome to DΛMZΞΞ NEWS. Check your email for your welcome message."
                    );
    ...
    async function loadHomepage() {
        ...
        console.log(
            `DΛMZΞΞ NEWS: ${articles.length} article(s) loaded.`
        );
    }
